...
public class Estruct_Selection_R_G {
    public static void main(String[] args) {
        ...
        int sumaA = 0,sumaB = 0,numx = 1, i1=0, i2=0;
            ...
            System.out.println("ingrese el valor maximo de un intervalo");//input
                ...
                if(num1 < num2 && num2 > num1){//si num1 es menor a num2 y num2 es mayor a num2
                    ...
                    do{
                        ...
                        if(numx > num2 || numx < num1){// si numx es mayor a num2 o si numx es menor a num1
                            sumaB += numx;//operador combiando
                            i2++;//incemento
                        }else{
                            sumaA += numx;//operador combinado
                            i1++;//incemento
                        } 
        ...
        System.out.println("la cantidad de numeros entre del intervalo es de: " + i1);//output
        System.out.println("la cantidad de numeros fuera del intervalo es de: " + i2);//output
